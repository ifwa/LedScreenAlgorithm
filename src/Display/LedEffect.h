...
// 特效种类
#define LED_EFFECT_LEFT                 0       // 特效: 左移
#define LED_EFFECT_RIGHT                1       // 特效: 右移
#define LED_EFFECT_UP                   2       // 特效: 上移
#define LED_EFFECT_DOWN                 3       // 特效: 下移
#define LED_EFFECT_FIXED                4       // 特效: 固定
#define LED_EFFECT_CARTOON              5       // 特效: 动画
#define LED_EFFECT_SNOW                 6       // 特效: 雪花
#define LED_EFFECT_SCROLL               7       // 特效: 画卷
#define LED_EFFECT_LASER                8       // 特效: 激光
...
// 特效状态
#define LED_EFFECT_STAT_NONE            0       // 无状态，待初始化
#define LED_EFFECT_STAT_APPEAR          1       // 显示出现状态
#define LED_EFFECT_STAT_HOLD            2       // 显示停留状态 (模式1与模式2)
#define LED_EFFECT_STAT_DISAPPEAR       3       // 显示消失状态 (模式1与模式2)
#define LED_EFFECT_STAT_ROLL            4       // 滚动显示状态 (模式3与模式4)
